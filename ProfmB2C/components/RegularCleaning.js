      ...
      renderItem={({ item: childItem }) => (
        <View>
          ...
          />
              ...
              <TouchableOpacity style={{ flexDirection: "row", margin: 3 }} onPress={() => navigation.navigate('ViewDetails2', { childItem })} >
         ...
         //</View> onPress={() => navigation.navigate('Forget')}
         >
...
<TouchableOpacity style={[styles.frameIcon2,{right:"-32%"}]}>
<Image
