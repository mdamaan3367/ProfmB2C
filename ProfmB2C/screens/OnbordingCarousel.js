...
const Pagination = ({ activeSlide }) => (
    <View style={styles.pagination}>
        <View style={[styles.dot, { backgroundColor: activeSlide === 0 ? 'black' : 'lightgrey' }]} />
        <View style={[styles.dot, { backgroundColor: activeSlide === 1 ? 'black' : 'lightgrey' }]} />
        <View style={[styles.dot, { backgroundColor: activeSlide === 2 ? 'black' : 'lightgrey' }]} />
    </View>
);
const OnbordingCarousel = () => {
  ...
  const windowWidth = Dimensions.get('window').width;
    ...
    const screens = [<OnBordeing onNext={() => goToNextSlide()}/>, <OnBordeing2 onNext={() => goToNextSlide()}/>, <OnBordeing3 onNext={() => goToNextSlide()}/>,<OnBordeing4 onNext={() => goToNextSlide()}/>]; // Array of screen components
