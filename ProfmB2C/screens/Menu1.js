...
import { Text, StyleSheet, View, Image, Pressable, Modal, ScrollView,Dimensions } from "react-native";
...
const Menu1 = () => {
  ...
  return (
    ...
    <ScrollView scrollEnabled={false}>
      <View style={[styles.menu, styles.menuLayout,{height:windowHeight+100,width:windowWidth}]}>
        ...
        <View style={styles.groupContainer}>
          <View style={styles.groupContainer}>
            ...
            <View style={[styles.rectangleGroup, styles.groupLayout]}>
              ...
              <Image
                style={[styles.profmLogo1111, styles.menuChildPosition]}
                resizeMode="cover"
