...
import { Image, StyleSheet, View, Text, Pressable, ScrollView,Dimensions } from "react-native";
...
const Profile = () => {
  ...
  return (
    ...
    <View style={[styles.profile, styles.iconLayout,{ height: windowHeight, width: windowWidth,}]}>
      <View
        style={[
      ...
      <Pressable
        style={[styles.encapsulatedGroupGroup, styles.encapsulatedGroupFlexBox]}
      ...
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/profm-logo1-1-1-21.png")}
      />
      <Pressable
